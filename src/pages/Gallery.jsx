...
const IMAGES = {
  personal: [
    ...
    },
    {
      ...
      photos: ["/gallery/hk.jpg", "/gallery/hk2.jpg"],
    },
  ],
  projects: [
    {
  id: 1,
  caption:
    "🛒 HK Store – A full-stack MERN eCommerce platform with authentication, admin dashboard, product management, cart system, and secure checkout.",
  photos: [
    "/gallery/hkstore1.png",
    "/gallery/hkstore2.png",
    "/gallery/hkstore3.png"
  ],
},
